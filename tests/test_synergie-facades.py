...
class TestSynergieFacades:
    ...
    def test_0(
        ...
        run(f"python3 ./src/main.py {test_directory_path}/config.scv -model 1")
    ...
    def test_1(
        ...
        run(f"python3 ./src/main.py {test_directory_path}/config.scv -model 2")
        assert_equality_of_actual_and_expected_output(
            test_directory_path,
            [
                "energy_yield.out",
    ...
    def test_2(
        ...
        run(f"python3 ./src/main.py {test_directory_path}/config.scv -model 3")
        assert_equality_of_actual_and_expected_output(
            test_directory_path,
            [
                "energy_yield.out",
